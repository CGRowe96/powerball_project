...
#--------------------------------------------------------Load Dataset----------------------------------------------------------------#
os.chdir(r"C:\Users\cgrow\Documents\GitHub\powerball_project\dataset")
df = pd.read_csv("powerball.csv")
os.chdir(r"C:\Users\cgrow\Documents\GitHub\powerball_project")
...
def probability_3col(col1,col2,col3):
    st_dev_dic = {'c1_-1_stdev':16,'c1_med':36,'c1_+1_stdev':56,
                  'c2_-1_stdev':14,'c2_med':34,'c2_+1_stdev':54,
                  'c3_-1_stdev':15,'c3_med':35,'c3_+1_stdev':55,
                  'c4_-1_stdev':15,'c4_med':35,'c4_+1_stdev':55,
    ...
    if col1 == 'choice1':
        ...
        if col2 == 'choice2':
            ...
            if col3 == 'choice3':
                col1vals = np.arange(st_dev_dic['c1_-1_stdev'],st_dev_dic['c1_+1_stdev']+1)
                col2vals = np.arange(st_dev_dic['c2_-1_stdev'],st_dev_dic['c2_+1_stdev']+1)
                col3vals = np.arange(st_dev_dic['c3_-1_stdev'],st_dev_dic['c3_+1_stdev']+1)
                cols = df2[[col1,col2,col3]]
                cols_list = cols.columns.to_list()
                for combo in it.combinations(cols_list,3):
                    print(df2[list(combo)].value_counts())
                    new_csv = pd.DataFrame(df2[list(combo)].value_counts())
                    new_csv.to_csv(f'{col1}_{col2}_{col3}_combos.csv')
                print(col1vals)
                print(col2vals)
                print(col3vals)
            if col3 == 'choice4':
                col1vals = np.arange(st_dev_dic['c1_-1_stdev'],st_dev_dic['c1_+1_stdev']+1)
                col2vals = np.arange(st_dev_dic['c2_-1_stdev'],st_dev_dic['c2_+1_stdev']+1)
                col3vals = np.arange(st_dev_dic['c4_-1_stdev'],st_dev_dic['c4_+1_stdev']+1)
                cols = df2[[col1,col2,col3]]
                cols_list = cols.columns.to_list()
                for combo in it.combinations(cols_list,3):
                    print(df2[list(combo)].value_counts())
            ...
            if col3 == 'choice5':
                col1vals = np.arange(st_dev_dic['c1_-1_stdev'],st_dev_dic['c1_+1_stdev']+1)
                col2vals = np.arange(st_dev_dic['c2_-1_stdev'],st_dev_dic['c2_+1_stdev']+1)
                col3vals = np.arange(st_dev_dic['c5_-1_stdev'],st_dev_dic['c5_+1_stdev']+1)
                cols = df2[[col1,col2,col3]]
                cols_list = cols.columns.to_list()
                for combo in it.combinations(cols_list,3):
                    print(df2[list(combo)].value_counts())
            ...
            if col3 == 'pb_choice':
                col1vals = np.arange(st_dev_dic['c1_-1_stdev'],st_dev_dic['c1_+1_stdev']+1)
                col2vals = np.arange(st_dev_dic['c2_-1_stdev'],st_dev_dic['c2_+1_stdev']+1)
                col3vals = np.arange(st_dev_dic['pb_-1_stdev'],st_dev_dic['pb_+1_stdev']+1)
                cols = df2[[col1,col2,col3]]
                cols_list = cols.columns.to_list()
                for combo in it.combinations(cols_list,3):
                    print(df2[list(combo)].value_counts())
...
probability_3col('choice1','choice2','choice4')

cols = df2[['choice1','choice2','choice3','choice4','choice5','pb_choice']]
cols_list = cols.columns.to_list()
for combo in it.combinations(cols_list,6):
    print(df2[list(combo)].value_counts())
    new_csv = pd.DataFrame(df2[list(combo)].value_counts())
    new_csv.to_csv(f'winning_combo_counts.csv')

'''
2000 draws, 2000 unique winning combinations
'''

#-----------------------------------------------Unique Counts------------------------------------------------------#

print(df2['choice1'].value_counts())
print(df2['choice2'].value_counts())
print(df2['choice3'].value_counts())
print(df2['choice4'].value_counts())
print(df2['choice5'].value_counts())
print(df2['pb_choice'].value_counts())
